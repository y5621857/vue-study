    ...
    <div class="sales-board-form">
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <my-number-box @on-change="onParamChange('buyNum',$event)"></my-number-box>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">
        ...
        <div class="sales-board-line-right">
          <my-selection :selections="productionTypes"
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <my-radio :selections="periodList"
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <my-check-box :selections="versionList"
...
<script>
  ...
  import MyRadio from '@/components/base/radioBox'
  import MyCheckBox from '@/components/base/checkBox'
  import MyNumberBox from '@/components/base/numberBox'
